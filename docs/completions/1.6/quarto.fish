...
# Quarto 1.6.43 (1.6 channel).
# Do not edit: https://github.com/mcanouil/quarto-completions

set -g __quarto_nodes 'render' 'preview' 'serve' 'create' 'use' 'use template' 'use binder' 'add' 'update' 'remove' 'convert' 'pandoc' 'typst' 'run' 'install' 'uninstall' 'tools' 'publish' 'check'
