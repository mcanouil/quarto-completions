...
_quarto_nodes="quarto quarto_render quarto_preview quarto_serve quarto_create quarto_use quarto_use_template quarto_use_binder quarto_add quarto_update quarto_remove quarto_convert quarto_pandoc quarto_typst quarto_run quarto_install quarto_uninstall quarto_tools quarto_publish quarto_check"
...
_quarto_valued() {
  case "$1" in
    ...
    quarto_check) vals="--log --log-level --log-format --profile" ;;
    *) vals="" ;;
  esac
}
...
_quarto() {
  ...
  if [[ "$cur" == -* ]]; then
    case "$cmd" in
      ...
      quarto_check) _quarto_words "-h --help --log --log-level --log-format --quiet --profile"; return ;;
    esac
    return
  fi
  ...
  if [ "$pos" = "0" ]; then
    case "$cmd" in
      quarto) _quarto_words "render preview serve create use add update remove convert pandoc typst run install uninstall tools publish check" ;;
