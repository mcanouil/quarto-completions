...
complete -c quarto -n '__quarto_is_quarto 0' -f -a "(__quarto_words 'update')" -d 'Updates an extension or global dependency (TinyTeX, Chromium, Chrome Headless Shell, VeraPDF).'
...
complete -c quarto -n '__quarto_is_quarto 0' -f -a "(__quarto_words 'install')" -d 'Installs a global dependency (TinyTeX, Chromium, Chrome Headless Shell, VeraPDF).'
complete -c quarto -n '__quarto_is_quarto 0' -f -a "(__quarto_words 'uninstall')" -d 'Uninstalls a global dependency (TinyTeX, Chromium, Chrome Headless Shell, VeraPDF).'
