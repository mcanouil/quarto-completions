...
_quarto_nodes="quarto quarto_render quarto_preview quarto_serve quarto_create quarto_use quarto_use_template quarto_use_binder quarto_add quarto_update quarto_remove quarto_convert quarto_pandoc quarto_typst quarto_run quarto_list quarto_install quarto_uninstall quarto_tools quarto_publish quarto_check quarto_call quarto_call_engine quarto_call_engine_julia quarto_call_engine_julia_status quarto_call_engine_julia_kill quarto_call_engine_julia_log quarto_call_engine_julia_close quarto_call_engine_julia_stop"
...
_quarto_valued() {
  case "$1" in
    ...
    quarto_use_binder) vals="--log --log-level --log-format --profile" ;;
    ...
    quarto_call_engine) vals="--log --log-level --log-format --profile" ;;
    quarto_call_engine_julia) vals="--log --log-level --log-format --profile" ;;
    quarto_call_engine_julia_status) vals="--log --log-level --log-format --profile" ;;
    quarto_call_engine_julia_kill) vals="--log --log-level --log-format --profile" ;;
    quarto_call_engine_julia_log) vals="--log --log-level --log-format --profile" ;;
    quarto_call_engine_julia_close) vals="--log --log-level --log-format --profile" ;;
    quarto_call_engine_julia_stop) vals="--log --log-level --log-format --profile" ;;
    *) vals="" ;;
  esac
}
...
_quarto() {
  ...
  case "${cmd}:::${prev}" in
    ...
    quarto_render:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_preview:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_serve:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_create:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_use_template:::--log-level) _quarto_words "info warning error critical"; return ;;
    quarto_use_template:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_use_binder:::--log) _quarto_files ""; return ;;
    quarto_use_binder:::--log-level) _quarto_words "info warning error critical"; return ;;
    quarto_use_binder:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_use_binder:::--profile) :; return ;;
    quarto_add:::--embed) :; return ;;
    quarto_add:::--log) _quarto_files ""; return ;;
    quarto_add:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_update:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_remove:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_convert:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_run:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_list:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_install:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_uninstall:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_publish:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_check:::--log-level) _quarto_words "info warning error critical"; return ;;
    ...
    quarto_call_engine:::--log-level) _quarto_words "info warning error critical"; return ;;
    quarto_call_engine:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_call_engine:::--profile) :; return ;;
    quarto_call_engine_julia:::--log) _quarto_files ""; return ;;
    quarto_call_engine_julia:::--log-level) _quarto_words "info warning error critical"; return ;;
    quarto_call_engine_julia:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_call_engine_julia:::--profile) :; return ;;
    quarto_call_engine_julia_status:::--log) _quarto_files ""; return ;;
    quarto_call_engine_julia_status:::--log-level) _quarto_words "info warning error critical"; return ;;
    quarto_call_engine_julia_status:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_call_engine_julia_status:::--profile) :; return ;;
    quarto_call_engine_julia_kill:::--log) _quarto_files ""; return ;;
    quarto_call_engine_julia_kill:::--log-level) _quarto_words "info warning error critical"; return ;;
    quarto_call_engine_julia_kill:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_call_engine_julia_kill:::--profile) :; return ;;
    quarto_call_engine_julia_log:::--log) _quarto_files ""; return ;;
    quarto_call_engine_julia_log:::--log-level) _quarto_words "info warning error critical"; return ;;
    quarto_call_engine_julia_log:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_call_engine_julia_log:::--profile) :; return ;;
    quarto_call_engine_julia_close:::--log) _quarto_files ""; return ;;
    quarto_call_engine_julia_close:::--log-level) _quarto_words "info warning error critical"; return ;;
    quarto_call_engine_julia_close:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_call_engine_julia_close:::--profile) :; return ;;
    quarto_call_engine_julia_stop:::--log) _quarto_files ""; return ;;
    quarto_call_engine_julia_stop:::--log-level) _quarto_words "info warning error critical"; return ;;
    quarto_call_engine_julia_stop:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_call_engine_julia_stop:::--profile) :; return ;;
  esac
  ...
  if [[ "$cur" == -* ]]; then
    case "$cmd" in
      ...
      quarto_use_binder) _quarto_words "-h --help --no-prompt --log --log-level --log-format --quiet --profile"; return ;;
      ...
      quarto_call_engine) _quarto_words "-h --help --log --log-level --log-format --quiet --profile"; return ;;
      quarto_call_engine_julia) _quarto_words "--log --log-level --log-format --quiet --profile -h --help"; return ;;
      quarto_call_engine_julia_status) _quarto_words "--log --log-level --log-format --quiet --profile -h --help"; return ;;
      quarto_call_engine_julia_kill) _quarto_words "--log --log-level --log-format --quiet --profile -h --help"; return ;;
      quarto_call_engine_julia_log) _quarto_words "--log --log-level --log-format --quiet --profile -h --help"; return ;;
      quarto_call_engine_julia_close) _quarto_words "--log --log-level --log-format --quiet --profile -h --help -f --force"; return ;;
      quarto_call_engine_julia_stop) _quarto_words "--log --log-level --log-format --quiet --profile -h --help"; return ;;
    esac
    return
  fi
  ...
  if [ "$pos" = "0" ]; then
    case "$cmd" in
      ...
      quarto_use) _quarto_words "template binder" ;;
      quarto_call) _quarto_words "engine" ;;
      quarto_call_engine) _quarto_words "julia" ;;
      quarto_call_engine_julia) _quarto_words "status kill log close stop" ;;
    esac
  fi
  ...
  case "${cmd}:::${pos}" in
    ...
    quarto_call_engine_julia_close:::0) :; return ;;
  esac
}
