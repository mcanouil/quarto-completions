...
# Quarto 1.7.34 (1.7 channel).
# Do not edit: https://github.com/mcanouil/quarto-completions

set -g __quarto_nodes 'render' 'preview' 'serve' 'create' 'use' 'use template' 'use binder' 'add' 'update' 'remove' 'convert' 'pandoc' 'typst' 'run' 'list' 'install' 'uninstall' 'tools' 'publish' 'check' 'call' 'call engine' 'call engine julia' 'call engine julia status' 'call engine julia kill' 'call engine julia log' 'call engine julia close' 'call engine julia stop'
...
function __quarto_valued --argument-names node
  switch "$node"
    ...
    case 'call engine'
      echo '--log --log-level --log-format --profile'
    case 'call engine julia'
      echo '--log --log-level --log-format --profile'
    case 'call engine julia status'
      echo '--log --log-level --log-format --profile'
    case 'call engine julia kill'
      echo '--log --log-level --log-format --profile'
    case 'call engine julia log'
      echo '--log --log-level --log-format --profile'
    case 'call engine julia close'
      echo '--log --log-level --log-format --profile'
    case 'call engine julia stop'
      echo '--log --log-level --log-format --profile'
    case '*'
      echo ""
  end
...
complete -c quarto -n '__quarto_is_quarto 0' -f -a "(__quarto_words 'update')" -d 'Updates an extension or global dependency.'
...
complete -c quarto -n '__quarto_is_quarto 0' -f -a "(__quarto_words 'install')" -d 'Installs a global dependency (TinyTex or Chromium).'
complete -c quarto -n '__quarto_is_quarto 0' -f -a "(__quarto_words 'uninstall')" -d 'Removes an extension.'
...
complete -c quarto -n '__quarto_is_quarto_render' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_preview' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_serve' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_create' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_use_template' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_use_binder' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_use_binder' -l 'profile' -r -f -d 'Active project profile(s)'
...
complete -c quarto -n '__quarto_is_quarto_add' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_update' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_remove' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_convert' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_run' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_list' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_install' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_uninstall' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_publish' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_check' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_call_engine 0' -f -a "(__quarto_words 'julia')" -d 'Access functionality specific to the julia rendering engine.'
...
complete -c quarto -n '__quarto_is_quarto_call_engine' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
...
complete -c quarto -n '__quarto_is_quarto_call_engine' -l 'profile' -r -f -d 'Active project profile(s)'
function __quarto_is_quarto_call_engine_julia --argument-names index
  __quarto_at 'call engine julia' $index
end
complete -c quarto -n '__quarto_is_quarto_call_engine_julia 0' -f -a "(__quarto_words 'status')" -d 'Get status information on the currently running Julia server process.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia 0' -f -a "(__quarto_words 'kill')" -d 'Kill the control server if it is currently running. This will also kill all notebook worker processes.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia 0' -f -a "(__quarto_words 'log')" -d 'Print the content of the julia server log file if it exists which can be used to diagnose problems.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia 0' -f -a "(__quarto_words 'close')" -d 'Close the worker for a given notebook. If it is currently running, it will not be interrupted.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia 0' -f -a "(__quarto_words 'stop')" -d 'Send a message to the server that it should close all notebooks and exit. This will fail if any notebooks are not idle.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia' -l 'quiet' -f -d 'Suppress console output.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia' -l 'profile' -r -f -d 'Active project profile(s)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia' -s 'h' -l 'help' -f -d 'Show this help.'
function __quarto_is_quarto_call_engine_julia_status --argument-names index
  __quarto_at 'call engine julia status' $index
end
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_status' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_status' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_status' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_status' -l 'quiet' -f -d 'Suppress console output.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_status' -l 'profile' -r -f -d 'Active project profile(s)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_status' -s 'h' -l 'help' -f -d 'Show this help.'
function __quarto_is_quarto_call_engine_julia_kill --argument-names index
  __quarto_at 'call engine julia kill' $index
end
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_kill' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_kill' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_kill' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_kill' -l 'quiet' -f -d 'Suppress console output.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_kill' -l 'profile' -r -f -d 'Active project profile(s)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_kill' -s 'h' -l 'help' -f -d 'Show this help.'
function __quarto_is_quarto_call_engine_julia_log --argument-names index
  __quarto_at 'call engine julia log' $index
end
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_log' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_log' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_log' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_log' -l 'quiet' -f -d 'Suppress console output.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_log' -l 'profile' -r -f -d 'Active project profile(s)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_log' -s 'h' -l 'help' -f -d 'Show this help.'
function __quarto_is_quarto_call_engine_julia_close --argument-names index
  __quarto_at 'call engine julia close' $index
end
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_close' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_close' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_close' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_close' -l 'quiet' -f -d 'Suppress console output.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_close' -l 'profile' -r -f -d 'Active project profile(s)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_close' -s 'h' -l 'help' -f -d 'Show this help.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_close' -s 'f' -l 'force' -f -d 'Force closing. This will terminate the worker if it is running. (Default: false)'
function __quarto_is_quarto_call_engine_julia_stop --argument-names index
  __quarto_at 'call engine julia stop' $index
end
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_stop' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_stop' -l 'log-level' -r -f -a "(__quarto_words 'info' 'warning' 'error' 'critical')" -d 'Log level (info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_stop' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_stop' -l 'quiet' -f -d 'Suppress console output.'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_stop' -l 'profile' -r -f -d 'Active project profile(s)'
complete -c quarto -n '__quarto_is_quarto_call_engine_julia_stop' -s 'h' -l 'help' -f -d 'Show this help.'
