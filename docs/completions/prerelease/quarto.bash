...
_quarto_valued() {
  case "$1" in
    quarto_render) echo "-t --to -o --output --output-dir -M --metadata --site-url -P --execute-param --execute-params --execute-dir --execute-daemon --log --log-level --log-format --profile --toc-depth --number-offset --top-level-division --template --css --bibliography --csl --highlight-style --pdf-engine --wrap --reference-doc --shift-heading-level-by" ;;
    quarto_preview) echo "--port --host --render --timeout --log --log-level --log-format --profile --toc-depth --number-offset --top-level-division --template --css --bibliography --csl --highlight-style --pdf-engine --wrap --reference-doc --shift-heading-level-by" ;;
    quarto_serve) echo "-p --port --host --log --log-level --log-format --profile" ;;
    quarto_create) echo "--open --log --log-level --log-format --profile" ;;
    quarto_use_template) echo "--log --log-level --log-format" ;;
    quarto_use_binder) echo "--log --log-level --log-format" ;;
    quarto_use_brand) echo "--log --log-level --log-format --profile" ;;
    quarto_add) echo "--embed --log --log-level --log-format --profile" ;;
    quarto_update) echo "--embed --log --log-level --log-format --profile" ;;
    quarto_remove) echo "--embed --log --log-level --log-format --profile" ;;
    quarto_convert) echo "-o --output --log --log-level --log-format --profile" ;;
    quarto_run) echo "--log --log-level --log-format --profile" ;;
    quarto_list) echo "--log --log-level --log-format --profile" ;;
    quarto_install) echo "--log --log-level --log-format --profile" ;;
    quarto_uninstall) echo "--log --log-level --log-format --profile" ;;
    quarto_publish) echo "--id --server --token --log --log-level --log-format --profile" ;;
    quarto_check) echo "--output --log --log-level --log-format --profile" ;;
    quarto_call_engine) echo "--log --log-level --log-format" ;;
    quarto_call_build_ts_extension) echo "--log --log-level --log-format" ;;
    quarto_call_typst_gather) echo "--log --log-level --log-format --profile" ;;
    *) echo "" ;;
  esac
}
...
_quarto() {
  ...
  case "${cmd}:::${prev}" in
    ...
    quarto_render:::--css) _quarto_files ""; return ;;
    quarto_render:::--bibliography) _quarto_files ""; return ;;
    quarto_render:::--csl) _quarto_files ""; return ;;
    ...
    quarto_render:::--reference-doc) _quarto_files ""; return ;;
    ...
    quarto_preview:::--css) _quarto_files ""; return ;;
    quarto_preview:::--bibliography) _quarto_files ""; return ;;
    quarto_preview:::--csl) _quarto_files ""; return ;;
    ...
    quarto_preview:::--reference-doc) _quarto_files ""; return ;;
