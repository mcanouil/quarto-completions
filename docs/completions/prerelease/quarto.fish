...
# Quarto 1.11.1 (prerelease channel), generated 2026-08-03.
...
complete -c quarto -n '__quarto_at "render"' -l css -r -F -d 'Link to a CSS style sheet.'
complete -c quarto -n '__quarto_at "render"' -l bibliography -r -F -d 'Bibliography file.'
complete -c quarto -n '__quarto_at "render"' -l csl -r -F -d 'Citation Style Language file.'
...
complete -c quarto -n '__quarto_at "render"' -l reference-doc -r -F -d 'Reference document for docx, pptx, or odt output.'
...
complete -c quarto -n '__quarto_at "preview"' -l css -r -F -d 'Link to a CSS style sheet.'
complete -c quarto -n '__quarto_at "preview"' -l bibliography -r -F -d 'Bibliography file.'
complete -c quarto -n '__quarto_at "preview"' -l csl -r -F -d 'Citation Style Language file.'
...
complete -c quarto -n '__quarto_at "preview"' -l reference-doc -r -F -d 'Reference document for docx, pptx, or odt output.'
