...
$script:QuartoCompletionSpec = @{
  ...
  'call engine julia close' = @{
    Options = @{
      ...
      '-h' = 'Show this help.'
      '--help' = 'Show this help.'
      '-f' = 'Force closing. This will terminate the worker if it is running. (Default: false)'
      '--force' = 'Force closing. This will terminate the worker if it is running. (Default: false)'
    }
    Commands = @{
