...
complete -c quarto -n '__quarto_at "" 0' -f -a 'inspect' -d 'Inspect a Quarto project or input path.'
...
complete -c quarto -n '__quarto_at "" 0' -f -a 'completions' -d 'Generate shell completions.'
...
complete -c quarto -n '__quarto_at "tools" 0' -f -a 'install' -d 'Installs a global dependency.'
complete -c quarto -n '__quarto_at "tools" 0' -f -a 'info' -d 'Shows the status of a global dependency.'
complete -c quarto -n '__quarto_at "tools" 0' -f -a 'uninstall' -d 'Uninstalls a global dependency.'
complete -c quarto -n '__quarto_at "tools" 0' -f -a 'update' -d 'Updates a global dependency.'
complete -c quarto -n '__quarto_at "tools" 0' -f -a 'list' -d 'Lists the status of every global dependency.'
...
complete -c quarto -n '__quarto_at "dev-call" 0' -f -a 'pull-git-subtree' -d 'Pull configured git subtrees.'
complete -c quarto -n '__quarto_at "dev-call" 0' -f -a 'typst-gather' -d 'Gather Typst packages for offline/hermetic builds.'
