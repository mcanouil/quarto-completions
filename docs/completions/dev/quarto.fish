...
function __quarto_valued --argument-names node
  switch "$node"
    ...
    case 'dev-call validate-yaml'
      echo '-s --schema --log --log-level --log-format'
    case 'dev-call build-artifacts'
      echo '--log --log-level --log-format'
    case 'dev-call show-ast-trace'
      echo '--log --log-level --log-format'
    case 'dev-call make-ast-diagram'
      echo '-m --mode --log --log-level --log-format'
    case 'dev-call pull-git-subtree'
      echo '--log --log-level --log-format'
...
complete -c quarto -n '__quarto_is_quarto_tools_install' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_tools_install' -l 'log-level' -r -f -a "(__quarto_words 'debug' 'info' 'warning' 'error' 'critical')" -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_tools_install' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_tools_install' -l 'quiet' -f -d 'Suppress console output.'
...
complete -c quarto -n '__quarto_is_quarto_tools_info' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_tools_info' -l 'log-level' -r -f -a "(__quarto_words 'debug' 'info' 'warning' 'error' 'critical')" -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_tools_info' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_tools_info' -l 'quiet' -f -d 'Suppress console output.'
...
complete -c quarto -n '__quarto_is_quarto_tools_uninstall' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_tools_uninstall' -l 'log-level' -r -f -a "(__quarto_words 'debug' 'info' 'warning' 'error' 'critical')" -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_tools_uninstall' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_tools_uninstall' -l 'quiet' -f -d 'Suppress console output.'
...
complete -c quarto -n '__quarto_is_quarto_tools_update' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_tools_update' -l 'log-level' -r -f -a "(__quarto_words 'debug' 'info' 'warning' 'error' 'critical')" -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_tools_update' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_tools_update' -l 'quiet' -f -d 'Suppress console output.'
...
complete -c quarto -n '__quarto_is_quarto_dev_call_validate_yaml' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_dev_call_validate_yaml' -l 'log-level' -r -f -a "(__quarto_words 'debug' 'info' 'warning' 'error' 'critical')" -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_dev_call_validate_yaml' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_dev_call_validate_yaml' -l 'quiet' -f -d 'Suppress console output.'
...
complete -c quarto -n '__quarto_is_quarto_dev_call_build_artifacts' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_dev_call_build_artifacts' -l 'log-level' -r -f -a "(__quarto_words 'debug' 'info' 'warning' 'error' 'critical')" -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_dev_call_build_artifacts' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_dev_call_build_artifacts' -l 'quiet' -f -d 'Suppress console output.'
...
complete -c quarto -n '__quarto_is_quarto_dev_call_show_ast_trace' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_dev_call_show_ast_trace' -l 'log-level' -r -f -a "(__quarto_words 'debug' 'info' 'warning' 'error' 'critical')" -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_dev_call_show_ast_trace' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_dev_call_show_ast_trace' -l 'quiet' -f -d 'Suppress console output.'
...
complete -c quarto -n '__quarto_is_quarto_dev_call_make_ast_diagram' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_dev_call_make_ast_diagram' -l 'log-level' -r -f -a "(__quarto_words 'debug' 'info' 'warning' 'error' 'critical')" -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_dev_call_make_ast_diagram' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_dev_call_make_ast_diagram' -l 'quiet' -f -d 'Suppress console output.'
...
complete -c quarto -n '__quarto_is_quarto_dev_call_pull_git_subtree' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_dev_call_pull_git_subtree' -l 'log-level' -r -f -a "(__quarto_words 'debug' 'info' 'warning' 'error' 'critical')" -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_dev_call_pull_git_subtree' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_dev_call_pull_git_subtree' -l 'quiet' -f -d 'Suppress console output.'
...
complete -c quarto -n '__quarto_is_quarto_dev_call_typst_gather' -l 'log' -r -F -d 'Path to log file'
complete -c quarto -n '__quarto_is_quarto_dev_call_typst_gather' -l 'log-level' -r -f -a "(__quarto_words 'debug' 'info' 'warning' 'error' 'critical')" -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_is_quarto_dev_call_typst_gather' -l 'log-format' -r -f -a "(__quarto_words 'plain' 'json-stream')" -d 'Log format (plain, json-stream)'
complete -c quarto -n '__quarto_is_quarto_dev_call_typst_gather' -l 'quiet' -f -d 'Suppress console output.'
