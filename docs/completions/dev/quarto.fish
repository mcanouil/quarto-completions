...
complete -c quarto -n '__quarto_at "" 0' -f -a 'render' -d 'Render files or projects to various document types.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'preview' -d 'Render and preview a document or website project.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'serve' -d 'Serve a Shiny interactive document.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'create' -d 'Create a Quarto project or extension'
complete -c quarto -n '__quarto_at "" 0' -f -a 'use' -d 'Automate document or project setup tasks.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'add' -d 'Add an extension to this folder or project'
complete -c quarto -n '__quarto_at "" 0' -f -a 'update' -d 'Updates an extension or global dependency (TinyTeX, Chromium (deprecated), Chrome Headless Shell, VeraPDF).'
complete -c quarto -n '__quarto_at "" 0' -f -a 'remove' -d 'Removes an extension.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'convert' -d 'Convert documents to alternate representations.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'pandoc' -d 'Run the version of Pandoc embedded within Quarto.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'typst' -d 'Run the version of Typst embedded within Quarto.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'run' -d 'Run a TypeScript, R, Python, or Lua script.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'list' -d 'Lists an extension or global dependency.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'install' -d 'Installs a global dependency (TinyTeX, Chromium (deprecated), Chrome Headless Shell, VeraPDF).'
complete -c quarto -n '__quarto_at "" 0' -f -a 'uninstall' -d 'Uninstalls a global dependency (TinyTeX, Chromium (deprecated), Chrome Headless Shell, VeraPDF).'
complete -c quarto -n '__quarto_at "" 0' -f -a 'tools' -d 'Display the status of Quarto installed dependencies'
complete -c quarto -n '__quarto_at "" 0' -f -a 'publish' -d 'Publish a document or project to a provider.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'check' -d 'Verify correct functioning of Quarto installation.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'call' -d 'Access functions of Quarto subsystems such as its rendering engines.'
complete -c quarto -n '__quarto_at "" 0' -f -a 'capabilities' -d 'Query for current capabilities (formats, engines, kernels etc.)'
complete -c quarto -n '__quarto_at "" 0' -f -a 'inspect' -d 'Inspect a Quarto project or input path. Inspecting a project returns its config and engines. Inspecting an input path return its formats, engine, and dependent resources. Emits results of inspection as JSON to output (or stdout if not provided).'
complete -c quarto -n '__quarto_at "" 0' -f -a 'editor-support' -d 'Miscellaneous tools to support Quarto editor modes'
complete -c quarto -n '__quarto_at "" 0' -f -a 'create-project' -d 'Create a project for rendering multiple documents'
complete -c quarto -n '__quarto_at "" 0' -f -a 'completions' -d 'Generate shell completions. To enable shell completions for this program add the following line to your ~/.bashrc or similar: source <(quarto completions [shell]) For more information run quarto completions [shell] --help'
complete -c quarto -n '__quarto_at "" 0' -f -a 'dev-call' -d 'Access internals of Quarto - this command is not intended for general use.'
...
complete -c quarto -n '__quarto_at "render"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "render"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "render"' -l top-level-division -r -f -a 'default section chapter part' -d 'Treat top-level headings as this division.'
...
complete -c quarto -n '__quarto_at "render"' -l pdf-engine -r -f -a 'pdflatex lualatex xelatex tectonic latexmk context wkhtmltopdf weasyprint typst' -d 'Engine used to produce PDF output.'
...
complete -c quarto -n '__quarto_at "preview"' -l render -r -f -a 'all html pdf docx odt rtf revealjs beamer pptx typst dashboard epub gfm commonmark markdown markua hugo-md docusaurus-md jats asciidoc asciidoctor ipynb context docbook dokuwiki jira mediawiki man ms muse opml org rst texinfo textile xwiki zimwiki' -d 'Render to the specified format(s) before previewing (Default: "none")'
...
complete -c quarto -n '__quarto_at "preview"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "preview"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "preview"' -l top-level-division -r -f -a 'default section chapter part' -d 'Treat top-level headings as this division.'
...
complete -c quarto -n '__quarto_at "preview"' -l pdf-engine -r -f -a 'pdflatex lualatex xelatex tectonic latexmk context wkhtmltopdf weasyprint typst' -d 'Engine used to produce PDF output.'
...
complete -c quarto -n '__quarto_at "serve"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "serve"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "create" 0' -f -a 'project extension'
complete -c quarto -n '__quarto_at "create"' -s h -l help -f -d 'Show this help.'
complete -c quarto -n '__quarto_at "create"' -l open -r -f -a 'positron vscode rstudio' -d 'Open new artifact in this editor (positron, vscode, rstudio)'
...
complete -c quarto -n '__quarto_at "create"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "create"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "use" 0' -f -a 'template' -d 'Use a Quarto template for this directory or project.'
complete -c quarto -n '__quarto_at "use" 0' -f -a 'binder' -d 'Configure the current project with Binder support.'
complete -c quarto -n '__quarto_at "use" 0' -f -a 'brand' -d 'Use a brand for this project.'
...
complete -c quarto -n '__quarto_at "use template"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "use template"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "use binder"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "use binder"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "use brand"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "use brand"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "add"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "add"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "update" 0+' -f -a 'tinytex chrome-headless-shell verapdf'
...
complete -c quarto -n '__quarto_at "update"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "update"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "remove"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
...
complete -c quarto -n '__quarto_at "convert"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
...
complete -c quarto -n '__quarto_at "run"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "list" 0' -f -a 'extensions tools'
...
complete -c quarto -n '__quarto_at "list"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "list"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "install" 0+' -f -a 'tinytex chrome-headless-shell verapdf'
...
complete -c quarto -n '__quarto_at "install"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "install"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "uninstall" 0' -f -a 'tinytex chrome-headless-shell verapdf'
...
complete -c quarto -n '__quarto_at "uninstall"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "uninstall"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "tools" 0' -f -a 'install' -d ''
complete -c quarto -n '__quarto_at "tools" 0' -f -a 'info' -d ''
complete -c quarto -n '__quarto_at "tools" 0' -f -a 'uninstall' -d ''
complete -c quarto -n '__quarto_at "tools" 0' -f -a 'update' -d ''
complete -c quarto -n '__quarto_at "tools" 0' -f -a 'list' -d ''
complete -c quarto -n '__quarto_at "tools"' -s h -l help -f -d 'Show this help.'
complete -c quarto -n '__quarto_at "tools install" 0' -f -a 'tinytex chrome-headless-shell verapdf'
complete -c quarto -n '__quarto_at "tools install"' -s h -l help -f -d 'Show this help.'
complete -c quarto -n '__quarto_at "tools info" 0' -f -a 'tinytex chrome-headless-shell verapdf'
complete -c quarto -n '__quarto_at "tools info"' -s h -l help -f -d 'Show this help.'
complete -c quarto -n '__quarto_at "tools uninstall" 0' -f -a 'tinytex chrome-headless-shell verapdf'
complete -c quarto -n '__quarto_at "tools uninstall"' -s h -l help -f -d 'Show this help.'
complete -c quarto -n '__quarto_at "tools update" 0' -f -a 'tinytex chrome-headless-shell verapdf'
...
complete -c quarto -n '__quarto_at "tools list"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "tools list"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "publish"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "publish"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "check" 0' -f -a 'install jupyter knitr versions all'
...
complete -c quarto -n '__quarto_at "check"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "check"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "call" 0' -f -a 'engine' -d 'Access functionality specific to quarto'\''s different rendering engines.'
complete -c quarto -n '__quarto_at "call" 0' -f -a 'build-ts-extension' -d 'Build TypeScript execution engine extensions.'
complete -c quarto -n '__quarto_at "call" 0' -f -a 'typst-gather' -d 'Gather Typst packages for a format extension.'
complete -c quarto -n '__quarto_at "call"' -s h -l help -f -d 'Show this help.'
complete -c quarto -n '__quarto_at "call engine" 0' -f -a 'jupyter knitr markdown julia'
...
complete -c quarto -n '__quarto_at "call engine"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "call engine"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "call build-ts-extension"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "call build-ts-extension"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "call typst-gather"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "call typst-gather"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "capabilities"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "capabilities"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "inspect"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "inspect"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "editor-support" 0' -f -a 'crossref' -d 'Index cross references for content'
...
complete -c quarto -n '__quarto_at "editor-support crossref"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "editor-support crossref"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "create-project"' -l type -r -f -a 'book default website manuscript' -d 'Project type (book, default, website, manuscript)'
complete -c quarto -n '__quarto_at "create-project"' -l template -r -f -d 'Use a specific project template'
complete -c quarto -n '__quarto_at "create-project"' -l engine -r -f -a 'jupyter knitr markdown julia' -d 'Use execution engine (jupyter, knitr, markdown, ...)'
complete -c quarto -n '__quarto_at "create-project"' -l editor -r -f -a 'source visual' -d 'Default editor for project ('\''source'\'' or '\''visual'\'')'
...
complete -c quarto -n '__quarto_at "create-project"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "create-project"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "completions" 0' -f -a 'bash' -d 'Generate shell completions for bash.'
complete -c quarto -n '__quarto_at "completions" 0' -f -a 'fish' -d 'Generate shell completions for fish.'
complete -c quarto -n '__quarto_at "completions" 0' -f -a 'zsh' -d 'Generate shell completions for zsh.'
...
complete -c quarto -n '__quarto_at "dev-call" 0' -f -a 'cli-info' -d 'Generate JSON information about the Quarto CLI.'
complete -c quarto -n '__quarto_at "dev-call" 0' -f -a 'validate-yaml' -d 'Validates a YAML file against Quarto'\''s schemas.'
complete -c quarto -n '__quarto_at "dev-call" 0' -f -a 'build-artifacts' -d 'Builds all the javascript assets necessary for IDE support.'
complete -c quarto -n '__quarto_at "dev-call" 0' -f -a 'show-ast-trace' -d 'Renders the document with AST tracing enabled and then shows the debugging output.'
complete -c quarto -n '__quarto_at "dev-call" 0' -f -a 'make-ast-diagram' -d 'Creates a diagram of the Pandoc AST.'
complete -c quarto -n '__quarto_at "dev-call" 0' -f -a 'pull-git-subtree' -d 'Pull configured git subtrees. This command pulls from configured subtree repositories using --squash, which creates two commits: a squash commit containing the subtree changes and a merge commit that integrates it into your branch.'
complete -c quarto -n '__quarto_at "dev-call" 0' -f -a 'typst-gather' -d 'Gather Typst packages for offline/hermetic builds. This command runs the typst-gather tool to download @preview packages and copy @local packages to a local directory for use during Quarto builds.'
...
complete -c quarto -n '__quarto_at "dev-call cli-info"' -l log-level -r -f -a 'debug info warning error critical' -d 'Log level (debug, info, warning, error, critical)'
complete -c quarto -n '__quarto_at "dev-call cli-info"' -l log-format -r -f -a 'plain json-stream' -d 'Log format (plain, json-stream)'
...
complete -c quarto -n '__quarto_at "dev-call pull-git-subtree" 0' -f -a 'all julia-engine orange-book'
