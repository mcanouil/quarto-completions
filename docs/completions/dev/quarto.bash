...
# Built from quarto-dev/quarto-cli main@97f222ff3934fa6291272cbf2d969405c636035b.
...
_quarto_valued() {
  case "$1" in
    ...
    quarto_tools_install) vals="--log --log-level --log-format" ;;
    quarto_tools_info) vals="--log --log-level --log-format" ;;
    quarto_tools_uninstall) vals="--log --log-level --log-format" ;;
    quarto_tools_update) vals="--log --log-level --log-format" ;;
    ...
    quarto_call_typst_gather) vals="--log --log-level --log-format" ;;
    ...
    quarto_dev_call_validate_yaml) vals="-s --schema --log --log-level --log-format" ;;
    quarto_dev_call_build_artifacts) vals="--log --log-level --log-format" ;;
    quarto_dev_call_show_ast_trace) vals="--log --log-level --log-format" ;;
    quarto_dev_call_make_ast_diagram) vals="-m --mode --log --log-level --log-format" ;;
    quarto_dev_call_pull_git_subtree) vals="--log --log-level --log-format" ;;
    quarto_dev_call_typst_gather) vals="--log --log-level --log-format --profile" ;;
    *) vals="" ;;
  esac
}
...
_quarto() {
  ...
  case "${cmd}:::${prev}" in
    ...
    quarto_tools_install:::--log) _quarto_files ""; return ;;
    quarto_tools_install:::--log-level) _quarto_words "debug info warning error critical"; return ;;
    quarto_tools_install:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_tools_info:::--log) _quarto_files ""; return ;;
    quarto_tools_info:::--log-level) _quarto_words "debug info warning error critical"; return ;;
    quarto_tools_info:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_tools_uninstall:::--log) _quarto_files ""; return ;;
    quarto_tools_uninstall:::--log-level) _quarto_words "debug info warning error critical"; return ;;
    quarto_tools_uninstall:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_tools_update:::--log) _quarto_files ""; return ;;
    quarto_tools_update:::--log-level) _quarto_words "debug info warning error critical"; return ;;
    quarto_tools_update:::--log-format) _quarto_words "plain json-stream"; return ;;
    ...
    quarto_dev_call_validate_yaml:::--log) _quarto_files ""; return ;;
    quarto_dev_call_validate_yaml:::--log-level) _quarto_words "debug info warning error critical"; return ;;
    quarto_dev_call_validate_yaml:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_dev_call_build_artifacts:::--log) _quarto_files ""; return ;;
    quarto_dev_call_build_artifacts:::--log-level) _quarto_words "debug info warning error critical"; return ;;
    quarto_dev_call_build_artifacts:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_dev_call_show_ast_trace:::--log) _quarto_files ""; return ;;
    quarto_dev_call_show_ast_trace:::--log-level) _quarto_words "debug info warning error critical"; return ;;
    quarto_dev_call_show_ast_trace:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_dev_call_make_ast_diagram:::-m|quarto_dev_call_make_ast_diagram:::--mode) :; return ;;
    quarto_dev_call_make_ast_diagram:::--log) _quarto_files ""; return ;;
    quarto_dev_call_make_ast_diagram:::--log-level) _quarto_words "debug info warning error critical"; return ;;
    quarto_dev_call_make_ast_diagram:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_dev_call_pull_git_subtree:::--log) _quarto_files ""; return ;;
    quarto_dev_call_pull_git_subtree:::--log-level) _quarto_words "debug info warning error critical"; return ;;
    quarto_dev_call_pull_git_subtree:::--log-format) _quarto_words "plain json-stream"; return ;;
    quarto_dev_call_typst_gather:::--log) _quarto_files ""; return ;;
    quarto_dev_call_typst_gather:::--log-level) _quarto_words "debug info warning error critical"; return ;;
    quarto_dev_call_typst_gather:::--log-format) _quarto_words "plain json-stream"; return ;;
  ...
  if [[ "$cur" == -* ]]; then
    case "$cmd" in
      ...
      quarto_tools_install) _quarto_words "-h --help --log --log-level --log-format --quiet"; return ;;
      quarto_tools_info) _quarto_words "-h --help --log --log-level --log-format --quiet"; return ;;
      quarto_tools_uninstall) _quarto_words "-h --help --log --log-level --log-format --quiet"; return ;;
      quarto_tools_update) _quarto_words "-h --help --log --log-level --log-format --quiet"; return ;;
      ...
      quarto_call_typst_gather) _quarto_words "-h --help --init-config --log --log-level --log-format --quiet"; return ;;
      ...
      quarto_dev_call_validate_yaml) _quarto_words "-h --help -s --schema --json --log --log-level --log-format --quiet"; return ;;
      quarto_dev_call_build_artifacts) _quarto_words "-h --help --log --log-level --log-format --quiet"; return ;;
      quarto_dev_call_show_ast_trace) _quarto_words "-h --help --log --log-level --log-format --quiet"; return ;;
      quarto_dev_call_make_ast_diagram) _quarto_words "-h --help -m --mode --log --log-level --log-format --quiet"; return ;;
      quarto_dev_call_pull_git_subtree) _quarto_words "-h --help --log --log-level --log-format --quiet"; return ;;
      quarto_dev_call_typst_gather) _quarto_words "-h --help --log --log-level --log-format --quiet --profile"; return ;;
    esac
    return
  fi
